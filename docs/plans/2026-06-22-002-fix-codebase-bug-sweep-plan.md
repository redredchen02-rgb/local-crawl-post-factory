...
- [ ] **U4: Reorder/idempotent-guard the publish tail to prevent cross-run duplicate publish**
...
- [ ] **U5: Sort cluster timestamps chronologically, not lexically**
...
- [ ] **U6: Include all generation inputs in the generate-article cache key**
...
- [ ] **U7: Make normalize-items resilient to a single bad record**
...
- [ ] **U8: Keep library-ingest stdout output consistent with committed DB state**
...
- [ ] **U10: Wrap LLM socket/read-timeout failures in `ExternalError`**
...
- [ ] **U11: Bound the crawl child process with a wall-clock timeout**
...
- [ ] **U12: Let `set_backend` clear `published_url` so rollback is consistent**
...
- [ ] **U13: Extract an atomic-write helper and use it for `manifest.save`**
...
- [ ] **U14: Apply atomic writes to auth storage_state and the WebUI dual-write**
...
- [ ] **U15: Harden the browser backend driver (4 fixes)**
...
- [ ] **U16: Re-bracket IPv6 hosts in `normalize_url`**
...
- [ ] **U17: Stop render-caption from duplicating/fragmenting the canonical_url**
...
- [ ] **U18: Give the prep pipeline a dict-shaped crawl progress callback**
...
- [ ] **U19: Resolve failure-image paths against the package dir**
...
- [ ] **U20: Apply multi-statement migrations per-statement (savepoint correctness)**
