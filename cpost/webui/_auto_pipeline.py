"""Auto-pipeline WebUI adapter: bridges cpost.core.pipeline.run_auto_pipeline to the job system."""

from cpost.browser import backend_driver
from cpost.core import jobs, pipeline
from cpost.core.schema import AutoPipelineResult, PipelineItem
...
def _run_auto_pipeline(
    ...
    Thin adapter: translates WebUI job callbacks to cpost.core.pipeline.run_auto_pipeline's
